...
电子科技小组招新要求对于大一同学，首先自己要明确目标，对软件或硬件方面感兴趣、想加入电子科技小组；其次要有一定的自学能力，最重要的是要有足够的耐心与恒心。非大一同学需在各学期成绩中，专业基础课、专业选修课、专业课中无挂科情况，专业排名处于前3%。报名硬件研究方向需要具有51单片机、32单片机的使用相关基础。报名软件研究方向需对一种语言擅长，并能够有参加相关学科竞赛的能力。
...
> Hi~ 恭喜你通过一轮面试、一轮笔试、前期集训、上机考核、寒假集训、二轮考核、二轮面试, 加入了咱们项目小组的大家庭, 我们在这里一起共同努力, 共同成长。
...
> 项目组前端方向采取先学广泛，再深入的方式，但是 JavaScript 是得扎扎实实去学习的，为以后解决定位工程化问题打下一个扎实的语言基础

#### 第零步

0、🙋‍♀️ 先将 gitHub 汉化

https://gist.github.com/ZRMYDYCG/c0751bc8bf368ecd6155293487ff273f
